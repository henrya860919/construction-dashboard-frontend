...
const { metrics, selectedKey, chartData, chartSummary, autoRotateEnabled, selectMetric } =
        ...
        <Card>
          <CardHeader class="flex flex-row items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <Button v-if="alertsError" variant="outline" size="sm" @click="reloadAlerts"
                >重試</Button
              >
            </div>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            <div class="grid w-full grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
              ...
              >
                <template #icon>
                  <component :is="monitoringIcons[m.key] ?? Thermometer" class="size-5" />
                </template>
              </MonitorCard>
            </div>
